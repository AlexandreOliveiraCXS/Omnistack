...
export default function Detail(){
    ...
    const message =`Olá ${incident.name}, estou entrando em contato pois eu gostaria de ajudar com o valor de ${Intl.NumberFormat('pt-BR',{
        style:'currency', 
        currency:'BRL'
    }).format(incident.value)}`;

    function naigationBack(){
        navigation.goBack();
    }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.detailsButton} onPress={naigationBack}>
